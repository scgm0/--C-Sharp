...
public static class 设定 {
	...
	public static readonly Dictionary<境界, 属性值> 属性 = new() {
		...
		{ 境界.炼精化气, new 属性值 { 寿命 = 1.5, 生命上限 = 1.5, 生命 = 1.5, 修为上限 = 2.0, 伤害 = 1.1} },
		{ 境界.炼气化神, new 属性值 { 寿命 = 1.5, 生命上限 = 1.5, 生命 = 1.5, 修为上限 = 2.0, 伤害 = 1.1} },
		{ 境界.炼神还虚, new 属性值 { 寿命 = 1.5, 生命上限 = 1.5, 生命 = 1.5, 修为上限 = 2.0, 伤害 = 1.1} },
		{ 境界.铜皮铁骨, new 属性值 { 寿命 = 2.0, 生命上限 = 2.0, 生命 = 2.0, 修为上限 = 3.0, 伤害 = 1.2} },
		{ 境界.毫发不爽, new 属性值 { 寿命 = 2.0, 生命上限 = 2.0, 生命 = 2.0, 修为上限 = 3.0, 伤害 = 1.2} },
		{ 境界.心领神会, new 属性值 { 寿命 = 2.0, 生命上限 = 2.0, 生命 = 2.0, 修为上限 = 3.0, 伤害 = 1.2} },
		{ 境界.滴血重生, new 属性值 { 寿命 = 2.5, 生命上限 = 2.5, 生命 = 2.5, 修为上限 = 4.0, 伤害 = 1.3} },
		{ 境界.合道同归, new 属性值 { 寿命 = 2.5, 生命上限 = 2.5, 生命 = 2.5, 修为上限 = 4.0, 伤害 = 1.3} },
		{ 境界.独步乾坤, new 属性值 { 寿命 = 2.5, 生命上限 = 2.5, 生命 = 2.5, 修为上限 = 4.0, 伤害 = 1.3} },
		{ 境界.武圣, new 属性值 { 寿命 = 3.0, 生命上限 = 3.0, 生命 = 3.0, 修为上限 = 5.0, 伤害 = 1.4} }
	};
}
